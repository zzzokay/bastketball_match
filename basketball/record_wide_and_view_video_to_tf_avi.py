...
典型用法：
    python3 record_wide_and_view_video_to_tf_avi.py \
...
class DualVideoRecorder:
    ...
    def start(self, wide_frame: np.ndarray, view_frame: np.ndarray):
        ...
        self.wide_path = os.path.join(self.wide_dir, f"wide_{ts}.avi")
        self.view_path = os.path.join(self.view_dir, f"view1920_{ts}.avi")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--fourcc", default="MJPG", help="视频编码 fourcc，默认 MJPG，建议配合 .avi 使用")
