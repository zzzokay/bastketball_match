...
使用方式：
    1. 采集标定图：
       python3 calib_imx219_camera.py --mode capture

    2. 计算标定参数：
       python3 calib_imx219_camera.py --mode calibrate

    3. 实时畸变矫正：
       python3 calib_imx219_camera.py --mode undistort
...
DEFAULT_SQUARE_SIZE = 20.0  # mm

DEFAULT_OUTPUT_DIR = "calib_images_imx219"
DEFAULT_CALIB_FILE = "camera_calib_imx219.npz"
    ...
    with TerminalKeyReader() as key_reader:
        while True:
            ...
            if not args.headless:
                ...
                cv2.imshow("IMX219 calibration capture", display)
    ...
    with TerminalKeyReader() as key_reader:
        while True:
            ...
            if not args.headless:
                ...
                cv2.imshow("IMX219 undistort", display)
            ...
            if key_char in ("s", "S"):
                filename = f"undistorted_imx219_{save_index:03d}.jpg"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="RK3588 + IMX219 camera calibration"
    )
